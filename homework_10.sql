...
--- birlikte görebileceğimiz LEFT JOIN sorgusunun SQL kodu:
...
--- first_name ve last_name isimlerini birlikte görebileceğimiz RIGHT JOIN sorgusunun SQL kodu:
...
--- first_name ve last_name isimlerini birlikte görebileceğimiz FULL JOIN sorgusunun SQL kodu:
SELECT customer.first_name, customer.last_name
FROM customer
FULL JOIN rental 
